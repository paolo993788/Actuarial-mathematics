...
THEMES = {
    "light": {
        ...
        "ordinal": ["#86b6ef", "#5598e7", "#2a78d6", "#1c5cab", "#104281"], "ordinal_note": "darker lines are more recent",
    },
    "dark": {
        ...
        "ordinal": ["#184f95", "#256abf", "#3987e5", "#6da7ec", "#9ec5f4"], "ordinal_note": "lighter lines are more recent",
    },
}
